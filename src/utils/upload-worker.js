 ...
 * @LastEditTime: 2023-04-26 21:23:39
 */
...
if ("function" === typeof importScripts) {
  ...
  // importScripts("https://cdn.bootcdn.net/ajax/libs/jszip/3.10.1/jszip.js");
  // importScripts("https://cdn.bootcdn.net/ajax/libs/FileSaver.js/2.0.5/FileSaver.js");
  onmessage = (e) => {
    const { file } = e.data;
    console.time("生成hash");
    sliceFile(file);
